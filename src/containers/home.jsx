      ...
      <React.Fragment>
        ...
        <div id="home" className="background-dark top-curtain">
          ...
          <p className="heading-5">
            Hi, my name is Kitty. I'm a digital designer/developer working in
            London.
          </p>
        </div>
        <main>
          <section className="background-light" id="work">
            ...
            <div className="d-flex flex-wrap justify-between">
              ...
              <div className="p-lg-1">
                ...
                <h4 className="heading-3 dark-text inline">
                  Want to see more?
                </h4>
          ...
          <section className="background-light bottom-curtain" id="values">
            ...
            <div className="d-flex flex-wrap">
              ...
              <article className="w-30">
                ...
                <h3 className="heading-4 dark-text">The user is key</h3>
                <p className="text dark-text">
              ...
              <article className="w-30">
                ...
                <h3 className="heading-4 dark-text">Inclusivity</h3>
                <p className="text dark-text">
                  From the culture of the office I work in, to the users I
                  consider, inclusivity is at the core of what I do. I consider
                  myself to by an A11y and will encourage all workplaces that I
                  am a part of to design and write code with accessibility in
                  mind.
                </p>
              </article>
              <article className="w-30">
                ...
                <h3 className="heading-4 dark-text">Ethical design</h3>
                <p className="text dark-text">
                  I believe that creating digital proucts is a privelidge that
                  comes with responsibilities to first do no harm. I want to be
                  a part of making digital products that affect positive changes
                  in the world.
                </p>
              </article>
              <article className="w-30">
                ...
                <h3 className="heading-4 dark-text">Collaboration</h3>
                <p className="text dark-text">
                  The best products are made by working collaboratively with a
                  myriad of different voices and opinions. I regularly add my
                  voice to the tech/deisgn scene by holding brown bag sessions
                  in my workplace, through articles I post on Medium, and
                  general ramblings on twitter.
                </p>
              </article>
            </div>
          </section>
        ...
        <div id="contact" className="background-dark">
          ...
          <div>
            <h2 className="heading-5 pl-40">Email: k.allen91@gmail.com</h2>
            <h2 className="heading-5 pl-40">Phone: 07869578311</h2>
          </div>
        </div>
      </React.Fragment>
    );
